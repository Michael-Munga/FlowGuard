...
function ExecutiveOverviewPageContent() {
...
export default function ExecutiveOverviewPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0B1420] text-white p-8">Loading Executive Overview...</div>}>
      <ExecutiveOverviewPageContent />
    </Suspense>
  );
}
