...
function EngineerDecisionsPageContent() {
...
export default function EngineerDecisionsPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0B1420] text-white p-8">Loading Active Decisions...</div>}>
      <EngineerDecisionsPageContent />
    </Suspense>
  );
}
