...
function EngineerHealthPageContent() {
...
export default function EngineerHealthPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0B1420] text-white p-8">Loading System Health...</div>}>
      <EngineerHealthPageContent />
    </Suspense>
  );
}
