...
export default function DepotLivePage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0B1420] text-white p-8">Loading Depot Live Yard...</div>}>
      <DepotLivePageContent />
    </Suspense>
  );
}
