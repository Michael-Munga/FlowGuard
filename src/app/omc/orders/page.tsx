...
export default function OmcOrdersPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0B1420] text-white p-8">Loading OMC Active Orders...</div>}>
      <OmcOrdersPageContent />
    </Suspense>
  );
}
