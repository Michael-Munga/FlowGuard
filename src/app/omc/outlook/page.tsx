...
function OmcOutlookPageContent() {
...
export default function OmcOutlookPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0B1420] text-white p-8">Loading OMC Collection Outlook...</div>}>
      <OmcOutlookPageContent />
    </Suspense>
  );
}
