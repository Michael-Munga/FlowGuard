...
function OperationsInterventionsPageContent() {
...
export default function OperationsInterventionsPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-[#0B1420] text-white p-8">Loading Interventions...</div>}>
      <OperationsInterventionsPageContent />
    </Suspense>
  );
}
